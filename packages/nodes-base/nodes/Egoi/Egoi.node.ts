...
export class Egoi implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Document Layout Extraction', 
		name: 'egoi',
		...
		defaults: {
			name: 'Document Layout Extraction',
		},
		inputs: ['main'],
		outputs: ['main'],
		credentials: [
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						action: 'Create a formula',
					},
					{
						name: 'Picture',
						value: 'Picture',
						description: 'Create a picture',
						action: 'Create a picture',
					},
					{
						name: 'Caption',
						value: 'Caption',
						description: 'Create a caption',
						action: 'Create a caption',
					},
					{
						name: 'Text',
						value: 'Text',
					...
					},
					{
						name: 'Page-header',
						value: 'Page-header',
						description: 'Create page-header',
						action: 'Create page-header',
					},
					{
						name: 'Page-footer',
						value: 'Page-footer',
						description: 'Create page-footer',
						action: 'Create page-footer',
					},
					// {
					// 	name: 'Create',
					// 	value: 'create',
