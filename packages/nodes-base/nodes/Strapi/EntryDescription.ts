		...
		options: [
			{
				name: 'Unsupervised',
				value: 'Unsupervised',
				description: 'Create an unsupervised entry',
				action: 'Create an unsupervised entry',
			},
			{
				name: 'Semi-supervised',
				value: 'Semi-supervised',
				description: 'Create an semi-supervised entry',
				action: 'Create an semi-supervised entry',
			},
			// {
			// 	name: 'Create',
			// 	value: 'create',
